...
CATALOG: list[dict[str, str]] = [
    ...
    {"provider": "openai", "model_id": "gpt-5-nano", "label": "GPT 5 Nano"},
    # Anthropic
    ...
    {"provider": "google", "model_id": "gemini-3.6-flash", "label": "Gemini 3.6 Flash"},
    ...
    {"provider": "groq", "model_id": "llama-4-scout", "label": "Llama 4 Scout (Groq)"},
    {
        ...
        "label": "Qwen3 Coder (Together)",
    },
    {
        "provider": "fireworks",
        "model_id": "accounts/fireworks/models/kimi-k2p5",
        "label": "Kimi (Fireworks)",
    },
    {
        "provider": "nvidia",
    ...
    {"provider": "custom", "model_id": "user-supplied", "label": "Custom endpoint"},
    {
        ...
        "label": "GPT 4.1 via GitHub Models",
    },
...
def catalog() -> list[dict[str, str]]:
    """Return selectable hints without claiming the user's account can access them."""
