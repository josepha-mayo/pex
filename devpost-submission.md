...
1. Download [PEX 0.1.0 RC18](https://github.com/josepha-mayo/pex/releases/tag/v0.1.0-rc18), or build current `main` with the pinned prerequisites in `README.md`.
...
- Working demo or test-build URL: https://github.com/josepha-mayo/pex/releases/tag/v0.1.0-rc18
