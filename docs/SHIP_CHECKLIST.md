...
Follow these steps in order; the seven stages below define their full acceptance criteria. Accepted source baseline is `9ba5f39`, including correction planning `4f034e1`, fresh control snapshots `e64270c`, received journal `db98481`, text transport `03045b5`, connection UI `cd39913`, cleanup `c15a2fc` and continuity `c0db453`. Main owns integration; bounded owners and independent reviewers must have explicit non-overlapping assignments. No agent currently owns UI edits.
