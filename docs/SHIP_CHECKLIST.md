...
Follow these steps in order; the seven stages below define their full acceptance criteria. Accepted source baseline is `c15a2fc`, including continuity `c0db453`. Main owns integration; bounded owners and independent reviewers must have explicit non-overlapping assignments. No agent currently owns UI edits.
