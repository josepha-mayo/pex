...
Follow these steps in order; the seven stages below define their full acceptance criteria. Accepted source baseline is `db98481`, including text transport `03045b5`, connection UI `cd39913`, cleanup `c15a2fc` and continuity `c0db453`. Main owns integration; bounded owners and independent reviewers must have explicit non-overlapping assignments. No agent currently owns UI edits.
