...
Use the public NSIS candidate from product source `bd0471f`. The
...
repeat that short visual card on exact `bd0471f` before filming. Current package
...
the focused automated gate but was not rerun as a live RC6 pair. Concentrate
...
3. ensure the installer offered to judges matches the filmed build. Public
   ...
   contains the accepted `bd0471f` installer and matching server-recorded hash;
