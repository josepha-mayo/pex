...
`build/release-candidate-c0b8860/PEX_0.1.0_x64-setup.exe` from the development
...
Expected bytes for `c0b8860`: `101666858`

Expected SHA-256:
`970CEDA244ADE8CADF8B8EC0F88244A852DE13CA8BFF48CA13B99855C5ED0F3F`
